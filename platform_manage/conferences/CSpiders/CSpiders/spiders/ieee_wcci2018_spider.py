...
class IEEE_WCCI2018(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        conference_item['url'] = 'http://www.ecomp.poli.br/~wcci2018/'
        ...
        #conference_item['name'] = temp_str6[0]
        conference_item['name'] = 'IEEE World Congress on Computational Intelligence'
